...
# -------------------------------
# Estimate ML model
ml_formula <- as.formula(paste("status_excl ~", paste(iv_vars_excl, collapse = " + ")))
ml_model <- multinom(ml_formula, data = final_data_excl, weights = weight)
summary(ml_model)
...
ml_model2_excl <- multinom(ml_formula2_excl, data = final_data_excl2, weights = weight)
summary(ml_model2_excl)
